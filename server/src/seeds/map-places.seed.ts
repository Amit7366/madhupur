/**
 * Must stay in sync with `client/src/lib/dummy/map-places.ts` → `MAP_PLACES`.
 * Used only for MongoDB seeding (`npm run seed`).
 */
import type { PlaceCategory } from "../models/place.model.js";

type Bilingual = { bn: string; en: string };

export type MapPlaceSeedRow = {
  id: string;
...
export const MAP_PLACES_SEED: MapPlaceSeedRow[] = [
  {
  ...
  {
    id: "seed-madhupur-high-school",
    category: "school",
    name: {
      bn: "Madhupur High School (sample)",
      en: "Madhupur High School (sample)",
    },
    address: {
      bn: "Madhupur municipal area",
      en: "Madhupur municipal area",
    },
    description: {
      bn: "Secondary school—confirm admission and schedule on site.",
      en: "Secondary school—confirm admission and schedule on site.",
    },
    services: {
      bn: "Education · Sports",
      en: "Education · Sports",
    ...
    hours: {
      bn: "Classes on school calendar weekdays.",
      en: "Classes on school calendar weekdays.",
    },
    image:
      "https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=900&q=80",
    dutyPhone: "09228-11111",
    dutyOfficer: { bn: "Head teacher", en: "Head teacher" },
    lat: 24.6208,
    lng: 90.036,
  },
  {
